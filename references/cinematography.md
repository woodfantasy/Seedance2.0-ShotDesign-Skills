...
| 英文术语 | 中文 | 运动轨迹 | 心理效果 |
|----------|------|----------|----------|
| Pan Left/Right | 水平摇摄 | 镜头固定，水平转动 | 追踪横向移动、展现广阔环境 |
| Tilt Up/Down | 垂直俯仰 | 镜头固定，垂直转动 | 仰拍强化力量感，俯拍表现脆弱 |
| Dolly In/Out | 推轨推进/后拉 | 机位前后物理移动 | 推进=建立亲密感；后拉=揭示孤立 |
| Zoom In/Out | 变焦推进/拉远 | 焦距变化，机位不动 | 快速聚焦或拉开距离 |
| Truck Left/Right | 横向平移 | 机位左右横向移动 | 展示并列元素 |
| Crane Up/Down | 摇臂升/降 | 机位垂直升降 | 升=宏大揭示；降=逐渐逼近 |
| Orbit / Arc | 环绕/弧形 | 围绕主体旋转 | 展示主体全貌、制造仪式感 |
| Tracking Shot | 跟踪镜头 | 跟随主体平行移动 | 保持主体焦点+传递速度感 |
| Static Shot | 固定镜头 | 机位不动 | 客观记录、冷静叙事 |
| Push In | 缓慢推进 | 缓慢靠近主体 | 累积紧张感、聚焦细节 |
| Pull Out | 缓慢拉出 | 缓慢远离主体 | 揭示更大环境 |
| Pedestal Up/Down | 升降平移 | 机身垂直升降不改俯仰角 | 跟随角色起立/坐下 |
